...
const amountRules: FieldRule[] = [{
    validator(value: number) {
        if (value < minimum) return t("funds.withdraw.minimum") + ":" + minimum
...
<template>
    <van-form class="grid gap-8" @submit="todo">
        <h6 class="pt-8 text-12">{{ $t('funds.withdraw.account') }}</h6>
        ...
        <div class="text-12 py-8 text-#999">
            ...
            <span class="pl-8">{{ $t('funds.withdraw.minimum') }}</span>
