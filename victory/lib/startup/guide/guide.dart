      ...
      contents: [
        TargetContent(
          ...
          customPosition: CustomTargetContentPosition(
            top: (guideStep1Key.currentContext?.findRenderObject() as RenderBox).localToGlobal(Offset.zero).dy,
            left: 0,
            right: 0,
          ),
          ...
          child: Container(
            ...
            child: GestureDetector(
              ...
              onTap: () => tutorial.next(),
              child: const Align(alignment: Alignment(0, 1), child: SizedBox(height: 48)),
            ),
          ),
        ),
      ],
