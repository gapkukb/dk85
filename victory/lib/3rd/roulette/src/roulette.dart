...
@visibleForTesting
class RouletteState extends State<Roulette> with SingleTickerProviderStateMixin {
  final _imageInfoNotifier = ValueNotifier(<int, ImageInfo>{});

  @visibleForTesting
  final rotateAnimation = ValueNotifier<Animation<double>>(const AlwaysStoppedAnimation(0));
