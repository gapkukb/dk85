...
import 'package:victory/3rd/roulette/utils/text.dart';
import 'package:victory/3rd/roulette/utils/transform_entry.dart';
...
class _RoulettePainter extends CustomPainter {
  ...
  bool shouldRepaint(covariant _RoulettePainter oldDelegate) {
    return oldDelegate.rotate != rotate || oldDelegate.group != group || oldDelegate.style != style || !mapEquals(oldDelegate.imageInfos, imageInfos);
  }
