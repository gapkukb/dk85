...
class DataView<T, R extends DataViewLogic> extends StatelessWidget {
  ...
  const DataView({super.key, required this.controller, this.enablePullDown = true, this.enablePullUp = false, required this.itemBuilder, this.separatorBuilder});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if (controller.data.isEmpty) return StateBlock();
  ...
  Widget _buildView() {
    ...
    final padding = EdgeInsets.fromLTRB(12, 0, 12, 12);
