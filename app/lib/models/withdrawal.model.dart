...
class WithdrawlModel {
  ...
  factory WithdrawlModel.fromJson(Map<String, dynamic> json) => WithdrawlModel(
    ...
    name: json["name"] ?? '',
    eachMin: stringToNum(json["each_min"], double.infinity),
    eachMax: stringToNum(json["each_max"], double.negativeInfinity),
    dailyMax: stringToNum(json["daily_max"], double.infinity),
