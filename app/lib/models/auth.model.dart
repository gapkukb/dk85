...
class AuthModelWrapper {
  ...
  AuthModelWrapper({required this.code, required this.status, required this.message, required this.data});

  factory AuthModelWrapper.fromRawJson(String str) => AuthModelWrapper.fromJson(json.decode(str));
