...
class _BaseInputState extends State<BaseInput> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        cursorHeight: Theme.of(context).inputDecorationTheme.hintStyle!.fontSize! * 1.2,
        ...
        decoration: widget.decoration.copyWith(
          ...
          helperText: '',
          counterText: '',
          helperStyle: const TextStyle(height: 1, fontSize: 10),
  ...
  Widget buildSuffix() {
    ...
    return Wrap(runAlignment: WrapAlignment.center, children: [buildClearButton(), widget.suffix!]);
  }
